package com.example.storyapp.story.upload
        ...
        RetrofitClient.instance.uploadImageWithLocation(
            ...
            override fun onResponse(call: Call<UploadResponse>, response: Response<UploadResponse>) {
                ...
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@UploadStoryActivity, "Upload gagal", Toast.LENGTH_SHORT).show()
                }
            }
            ...
            override fun onFailure(call: Call<UploadResponse>, t: Throwable) {
                binding.loadingProgressBar.visibility = View.GONE
                Toast.makeText(this@UploadStoryActivity, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
